...
public enum L10n {
  ...
  public enum Common {
    ...
    /// Обновить
    public static let refresh = L10n.tr("Localizable", "common.refresh")
    /// %@ год
    public static func year(_ p1: Any) -> String {
      return L10n.tr("Localizable", "common.year", String(describing: p1))
    }
    public enum NetworkError {
      public enum NoInternet {
        /// Проверьте свое подключение к сети и повторите попытку
        public static let description = L10n.tr("Localizable", "common.networkError.noInternet.description")
        /// Нет соединения
        public static let title = L10n.tr("Localizable", "common.networkError.noInternet.title")
      }
      public enum Unknown {
        /// Неизвестная ошибка
        public static let title = L10n.tr("Localizable", "common.networkError.unknown.title")
      }
    }
  }
  ...
  public enum Schedule {
    ...
    public static func attestation(_ p1: Any) -> String {
      return L10n.tr("Localizable", "schedule.attestation", String(describing: p1))
    }
    /// Образование
    public static let education = L10n.tr("Localizable", "schedule.education")
    /// Опыт: %@ лет
    public static func experience(_ p1: Any) -> String {
      return L10n.tr("Localizable", "schedule.experience", String(describing: p1))
    }
    /// Группа: %@
    public static func group(_ p1: Any) -> String {
      return L10n.tr("Localizable", "schedule.group", String(describing: p1))
    }
    /// Должность: %@
    public static func position(_ p1: Any) -> String {
      return L10n.tr("Localizable", "schedule.position", String(describing: p1))
    }
    /// Посмотреть
    ...
    public static func teacher(_ p1: Any) -> String {
      return L10n.tr("Localizable", "schedule.teacher", String(describing: p1))
    }
    /// Педагог
    public static let teacherTitle = L10n.tr("Localizable", "schedule.teacherTitle")
    /// Неделя: %@
    public static func week(_ p1: Any) -> String {
      return L10n.tr("Localizable", "schedule.week", String(describing: p1))
    }
    /// Тематика недели: %@
    public static func weekTheme(_ p1: Any) -> String {
      return L10n.tr("Localizable", "schedule.weekTheme", String(describing: p1))
    }
  }
